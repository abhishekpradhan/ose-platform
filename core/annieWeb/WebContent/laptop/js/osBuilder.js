...
function init(){
	...
	var fieldNames = getFieldNames();
		...
		popup1.add('Moni', function(target) {
	    	addSelectionToTaggingField('moni');
			});
	
		popup1.add('Hdd', function(target) {
	    	addSelectionToTaggingField('hdd');
			});
	
		popup1.add('Proc', function(target) {
	    	addSelectionToTaggingField('proc');
			});
