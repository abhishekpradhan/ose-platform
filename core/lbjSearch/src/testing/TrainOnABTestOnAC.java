...
public class TrainOnABTestOnAC {
...
//		learnBoth(trainingData, depts);
	...
	private static void learnBoth(DocQueryFileParser dataParser, String[] trainingDepts) {
		...
		Set<Integer> allDocIds = getDocIdsWithField(dataParser.getDocs(),"dept",  partitions);
	...
	private static void trainAndTestBrands(DocQueryFileParser trainingData,
		...
		Set<Integer> trainingDocIds = getDocIdsWithField(trainingData.getDocs(), "dept", trainingBrands);
		Set<Integer> testingDocIds = getDocIdsWithField(trainingData.getDocs(), "dept", testingBrands);
...
//		}
	...
	static private Set<Integer> getDocIdsWithField(List<DocumentFromTrec> docs, String field , Set<String> fieldLabels){
