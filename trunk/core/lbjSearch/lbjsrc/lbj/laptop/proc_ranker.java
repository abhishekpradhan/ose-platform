...
// 
...
public class proc_ranker extends SparseAveragedPerceptron
{
  public static boolean isTraining = false;
  private static java.net.URL lcFilePath;
  private static proc_ranker instance;
  public static proc_ranker getInstance()
  {
    if (instance == null)
      instance = (proc_ranker) Classifier.binaryRead(lcFilePath, "proc_ranker");
    return instance;
  }

  static
  {
    lcFilePath = proc_ranker.class.getResource("proc_ranker.lc");

    if (lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate proc_ranker.lc in the class path.");
      System.exit(1);
    }
  }
  ...
  public void save()
  {
    ...
    {
      System.err.println("WARNING: proc_ranker.lc is part of a jar file.  It will be written to the current directory.  Use 'jar -u' to update the jar file.  To avoid seeing this message in the future, unpack the jar file and put the unpacked files on your class path instead.");
      instance.binaryWrite(System.getProperty("user.dir") + java.io.File.separator + "proc_ranker.lc", "proc_ranker");
    }
    else instance.binaryWrite(lcFilePath.getPath(), "proc_ranker");
  }
  ...
  public proc_ranker()
  {
    super("lbj.laptop.proc_ranker");
    isClone = true;
    if (instance == null)
      instance = (proc_ranker) Classifier.binaryRead(lcFilePath, "proc_ranker");
  }

  private proc_ranker(boolean b)
  {
    super(1.0, 0, 2);
    containingPackage = "lbj.laptop";
    name = "proc_ranker";
    setLabeler(new Oracle());
    setExtractor(new proc_features());
    isClone = false;
  }
  ...
  public void learn(Object example)
  {
    ...
    if (!(example instanceof DocQueryPair))
    {
      ...
      else
      {
        ...
        System.err.println("Classifier 'proc_ranker(DocQueryPair)' defined on line 77 of laptop_s37.lbj received '" + type + "' as input.");
...
__classify:
    {
      if (__example == proc_ranker.exampleCache.get()) break __classify;
      proc_ranker.exampleCache.set(__example);

      proc_ranker.cache.set(super.classify(__example));
    }

    if (__saveExtractor != this.extractor) setExtractor(__saveExtractor);
    return (FeatureVector) proc_ranker.cache.get();
  }
  ...
  public int hashCode() { return "proc_ranker".hashCode(); }
  public boolean equals(Object o) { return o instanceof proc_ranker; }
