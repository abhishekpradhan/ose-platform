...
// 
...
public class univ_ranker extends SparseAveragedPerceptron
{
  ...
  public univ_ranker()
  {
    super("lbj.professor.pairwise.univ_ranker");
    isClone = true;
    if (instance == null)
      instance = (univ_ranker) Classifier.binaryRead(lcFilePath, "univ_ranker");
  }
  ...
  public void learn(Object example)
  {
    ...
    if (!(example instanceof GenericPair))
    {
      ...
      else
      {
        ...
        System.err.println("Classifier 'univ_ranker(GenericPair)' defined on line 21 of pairwise_professor_s3.lbj received '" + type + "' as input.");
