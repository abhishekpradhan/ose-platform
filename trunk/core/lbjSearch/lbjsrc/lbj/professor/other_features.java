...
public class other_features extends Classifier
{
  ...
  public other_features() { super("lbj.professor.other_features"); }
  ...
  public FeatureVector classify(Object example)
  {
    if (!(example instanceof DocQueryPair))
    {
      ...
      System.err.println("Classifier 'other_features(DocQueryPair)' defined on line 9 of professor_s1.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    for (int i = 0; i < examples.length; ++i)
      ...
      {
        System.err.println("Classifier 'other_features(DocQueryPair)' defined on line 9 of professor_s1.lbj received '" + examples[i].getClass().getName() + "' as input.");
        new Exception().printStackTrace();
        System.exit(1);
      }
