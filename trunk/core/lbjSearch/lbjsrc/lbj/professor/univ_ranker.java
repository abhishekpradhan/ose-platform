...
// 
...
public class univ_ranker extends SparseAveragedPerceptron
{
  public static boolean isTraining = false;
  private static java.net.URL lcFilePath;
  private static univ_ranker instance;
  public static univ_ranker getInstance()
  {
    if (instance == null)
      instance = (univ_ranker) Classifier.binaryRead(lcFilePath, "univ_ranker");
    return instance;
  }

  static
  {
    lcFilePath = univ_ranker.class.getResource("univ_ranker.lc");

    if (lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate univ_ranker.lc in the class path.");
      System.exit(1);
    }
  }
  ...
  public void save()
  {
    ...
    {
      System.err.println("WARNING: univ_ranker.lc is part of a jar file.  It will be written to the current directory.  Use 'jar -u' to update the jar file.  To avoid seeing this message in the future, unpack the jar file and put the unpacked files on your class path instead.");
      instance.binaryWrite(System.getProperty("user.dir") + java.io.File.separator + "univ_ranker.lc", "univ_ranker");
    }
    else instance.binaryWrite(lcFilePath.getPath(), "univ_ranker");
  }
  ...
  public univ_ranker()
  {
    super("lbj.professor.univ_ranker");
    isClone = true;
    if (instance == null)
      instance = (univ_ranker) Classifier.binaryRead(lcFilePath, "univ_ranker");
  }

  private univ_ranker(boolean b)
  {
    super(1.0, 0, 2);
    containingPackage = "lbj.professor";
    name = "univ_ranker";
    setLabeler(new Oracle());
    setExtractor(new univ_features());
    isClone = false;
  }
  ...
  public void learn(Object example)
  {
    ...
    if (!(example instanceof DocQueryPair))
    {
      ...
      else
      {
        ...
        System.err.println("Classifier 'univ_ranker(DocQueryPair)' defined on line 69 of professor_s3.lbj received '" + type + "' as input.");
...
__classify:
    {
      if (__example == univ_ranker.exampleCache.get()) break __classify;
      univ_ranker.exampleCache.set(__example);

      univ_ranker.cache.set(super.classify(__example));
    }

    if (__saveExtractor != this.extractor) setExtractor(__saveExtractor);
    return (FeatureVector) univ_ranker.cache.get();
  }
  ...
  public int hashCode() { return "univ_ranker".hashCode(); }
  public boolean equals(Object o) { return o instanceof univ_ranker; }
