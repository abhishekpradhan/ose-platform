...
// 
...
public class name_ranker extends SparseAveragedPerceptron
{
  ...
  public name_ranker()
  {
    super("lbj.professor.name_ranker");
    isClone = true;
    if (instance == null)
      instance = (name_ranker) Classifier.binaryRead(lcFilePath, "name_ranker");
  }
  ...
  public void learn(Object example)
  {
    ...
    if (!(example instanceof DocQueryPair))
    {
      ...
      else
      {
        ...
        System.err.println("Classifier 'name_ranker(DocQueryPair)' defined on line 81 of professor_s4.lbj received '" + type + "' as input.");
